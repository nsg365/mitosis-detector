...
% SLIDE 3b: Preprocessing Visualized
\begin{frame}
  \frametitle{Preprocessing: Macenko Normalization}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{outputs/06_stain_normalisation_before_after.png}
    \caption{\small Standardizing varied H\&E staining protocols.}
  \end{figure}
\end{frame}

% SLIDE 3c: Dataset Imbalance
\begin{frame}
  \frametitle{Dataset Imbalance}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{outputs/01_class_imbalance.png}
    \caption{\small Severe class imbalance necessitates focal loss.}
  \end{figure}
\end{frame}
...
% SLIDE 5b: Stage 1 Threshold Analysis
\begin{frame}
  \frametitle{Stage 1: Threshold Selection}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{outputs/stage1_threshold_analysis.png}
    \caption{\small Precision-Recall tradeoff. Selected $\tau=0.5087$ to maximize recall for screening.}
  \end{figure}
\end{frame}
...
% SLIDE 6b: Stage 2 Evaluation
\begin{frame}
  \frametitle{Stage 2: FROC Evaluation}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{outputs/froc_curve.png}
    \caption{\small Free-Response ROC curve for the Stage 2 detector.}
  \end{figure}
\end{frame}
...
% SLIDE 8b: Detection Results
\begin{frame}
  \frametitle{Qualitative Results: Detection Patches}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{outputs/05_stage2_detection_patches.png}
    \caption{\small Example bounding box predictions on validation patches.}
  \end{figure}
\end{frame}
...
% SLIDE 9b: Model Explainability
\begin{frame}
  \frametitle{Model Interpretability}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{outputs/gradcam_misclassifications.png}
    \caption{\small Grad-CAM showing regions of focus during inference.}
  \end{figure}
\end{frame}
...
% SLIDE 13b: Demo Interface Picture
\begin{frame}
  \frametitle{Demo Interface}
  \begin{figure}
    \centering
